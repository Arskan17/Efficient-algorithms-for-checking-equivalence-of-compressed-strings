...
def generate_fibonacci_grammar(i):
    ...
    Uses the recursive definition: H_i = H_{i-1}H_{i-2} for i >= 3.
...
def m(index):
    if index < 3:
        ...
        print(f"The H-{index} is of size: {fibonacci(index)}")
